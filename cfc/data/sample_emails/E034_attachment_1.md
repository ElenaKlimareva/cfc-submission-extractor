...
* **Name of Applicant**: Zenith Diagnostics Ltd
* **Street Address**: 151 Harbour View Road, Belgium
* **City, State, Zip**: Leeds, LS1 4DY
* **Phone**: +44 20 7102 5542
* **Website**: www.zenithdiagnosticsl.example
* **Fax**:
...
* **c. Description of operations**: Fintech
* **d. Total number of employees**: 1361
...
|---|---|---|---|
| Total gross revenues | £46,981,280 | £44,744,077 | £35,347,820 |
...
* **a. Within the Applicant's organization, who is responsible for network security?**
    ...
    * **Phone**: +44 20 7356 3858
    * **Email address**: jordan.foster@example-insured.test
* **b. The Applicant's network security is:**
    * Outsourced; provide the name of your network security provider: Nexus Managed Services [ ]
    * Managed internally/in-house [x]
* **d. How many IT personnel are on your team?** 28
...
Primary applicant contact for underwriting queries: Quinn Foster, Operations Director, quinn.foster@example-insured.test.
...
Prior year revenue reference (audited accounts): £39,374,787
