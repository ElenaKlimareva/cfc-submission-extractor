...
* **Name of Applicant**: Westhaven Insights Holdings Ltd
* **Street Address**: 148 Harbour View Road, Denmark
* **City, State, Zip**: Birmingham, B3 2QD
* **Phone**: +44 20 7729 6780
* **Website**: www.westhaveninsightsh.example
* **Fax**:
...
* **a. Applicant is a(an)**:
    ...
    * Partnership [ ]
    * Other:      [ ]
* **b. Date established**: 1997
* **c. Description of operations**: Logistics
* **d. Total number of employees**: 746
...
| | Current Fiscal Year ending 9 / 25 (projected) | Last Fiscal Year ending 9 / 24 | Two Fiscal Years ago ending 9 / 23 |
|---|---|---|---|
| Total gross revenues | £31,329,991 | £29,838,087 | £23,572,088 |

### 4. TERRITORIES

| Country / territory | Approx. % revenue | Employees on site |
|---|---|---|
| Denmark | 41% | 281 |
| United States | 41% | 262 |
| Singapore | 25% | 202 |


### 5. RECORDS
* **a. Do you collect, store, host, process, control, use or share any private or sensitive information* in either paper or electronic form?**
    * Yes [x]
    * No [ ]
    * **If "Yes", provide the approximate number of unique records**:
        * **Paper records**: 3851
        * **Electronic records**: 21412
* **b. Do you collect, store, host, process, control, use or share any biometric information or data?**
    * Yes [ ]
    * No [x]
...
### 7. IT DEPARTMENT
This section must be completed by the individual within the Applicant's organization who is responsible for network security.

* **a. Within the Applicant's organization, who is responsible for network security?**
    * **Name**: Casey Griffin
    * **Title**: Finance Director
    * **Phone**: +44 20 7291 2402
    * **Email address**: casey.griffin@example-insured.test
* **b. The Applicant's network security is:**
    * Outsourced; provide the name of your network security provider: Guardian Technology Partners [x]
    * Managed internally/in-house [x]
* **d. How many IT personnel are on your team?** 6
* **e. How many dedicated IT security personnel are on your team?** 6

Print/Type Name: Casey Griffin
...
Primary applicant contact for underwriting queries: Avery Shaw, Chief Information Officer, avery.shaw@example-insured.test.

# 9. LOSS HISTORY

* **a. In the past 3 years, has the Applicant received any complaints or written demands or been a subject in litigation involving matters of privacy injury, breach of private information, or network security?**
    * Yes [ ]
    * No [x]

Prior year revenue reference (audited accounts): £26,257,516
