...
* **Name of Applicant**: Ridgeway Healthcare Ltd
* **Street Address**: 175 Foundry Lane, Norway
* **City, State, Zip**: Edinburgh, EH2 3JP
* **Phone**: +44 20 7580 8245
* **Website**: www.ridgewayhealthcare.example
* **Fax**:
...
* **a. Applicant is a(an)**:
    ...
    * Partnership [ ]
    * Other:      [ ]
* **b. Date established**: 2004
* **c. Description of operations**: Software Services
* **d. Total number of employees**: 159
...
|---|---|---|---|
| Total gross revenues | £10,948,587 | £10,427,226 | £8,237,508 |
...
* **a. Within the Applicant's organization, who is responsible for network security?**
    ...
    * **Phone**: +44 20 7157 6766
    * **Email address**: avery.morgan@example-insured.test
* **b. The Applicant's network security is:**
    * Outsourced; provide the name of your network security provider: Nexus Managed Services [x]
    * Managed internally/in-house [x]
* **d. How many IT personnel are on your team?** 31
* **e. How many dedicated IT security personnel are on your team?** 1

Print/Type Name: Avery Morgan
...
Primary applicant contact for underwriting queries: Jordan Walsh, Chief Information Officer, jordan.walsh@example-insured.test.
...
Prior year revenue reference (audited accounts): £9,175,958
