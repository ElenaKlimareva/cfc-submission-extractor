...
* **Name of Applicant**: Copperfield Properties Ltd
* **Street Address**: 114 Innovation Way, Sweden
* **City, State, Zip**: Bristol, BS1 6XN
* **Phone**: +44 20 7915 1919
* **Website**: www.copperfieldpropert.example
* **Fax**:
...
* **a. Applicant is a(an)**:
    ...
    * Partnership [ ]
    * Other:      [ ]
* **b. Date established**: 2008
* **c. Description of operations**: Energy
* **d. Total number of employees**: 1095
...
| | Current Fiscal Year ending 4 / 25 (projected) | Last Fiscal Year ending 4 / 24 | Two Fiscal Years ago ending 4 / 23 |
|---|---|---|---|
| Total gross revenues | £3,579,042 | £3,408,612 | £2,692,803 |
...
* **a. Within the Applicant's organization, who is responsible for network security?**
    * **Name**: Avery Reed
    * **Title**: Head of Risk
    * **Phone**: +44 20 7541 3385
    * **Email address**: avery.reed@example-insured.test
* **b. The Applicant's network security is:**
    * Outsourced; provide the name of your network security provider: Bridgeport IT Partners [ ]
    * Managed internally/in-house [ ]
* **d. How many IT personnel are on your team?** 16
* **e. How many dedicated IT security personnel are on your team?** 8

Print/Type Name: Avery Reed
...
Primary applicant contact for underwriting queries: Morgan Bennett, Head of Risk, morgan.bennett@example-insured.test.
...
Prior year revenue reference (audited accounts): £2,999,578
